<?php
	...
	//Paginador
	$sql_registe = mysqli_query($conection,"SELECT COUNT(*) as total_registro FROM marca
															WHERE ( idmarca LIKE '%$busqueda%' OR
																marca LIKE '%$busqueda%' OR
																descripcion LIKE '%$busqueda%'
														   	) AND estatus != 10 ORDER BY marca ASC ");
	...
	$query = mysqli_query($conection,"SELECT * FROM marca
												WHERE
													( idmarca LIKE '%$busqueda%' OR
													  marca LIKE '%$busqueda%' OR
													  descripcion LIKE '%$busqueda%' )
													AND
													estatus != 10 ORDER BY marca ASC LIMIT $desde,$por_pagina
		");
...
<body>
	...
	<section id="container">
		<h1> <i class="fab fa-bandcamp"></i> Buscar de marcas</h1>
