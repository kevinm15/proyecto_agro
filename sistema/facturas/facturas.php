<?php
	...
	//Paginador
	$sql_registe = mysqli_query($conection,"SELECT COUNT(*) as total_registro FROM facturas WHERE status != 10 ");
	...
	$query = mysqli_query($conection,"SELECT * FROM facturas WHERE status != 10 ORDER BY idserie ASC LIMIT $desde,$por_pagina");
...
<body>
	...
	<section id="container">
		<h1> <i class="fas fa-file-alt"></i></i> Facturas</h1>
