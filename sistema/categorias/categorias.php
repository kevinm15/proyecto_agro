<?php
	...
	//Paginador
	$sql_registe = mysqli_query($conection,"SELECT COUNT(*) as total_registro FROM categoria WHERE estatus != 10 ");
	...
	$query = mysqli_query($conection,"SELECT * FROM categoria WHERE estatus != 10 ORDER BY categoria ASC LIMIT $desde,$por_pagina
		");
