<?php
	...
	$queryExport = "SELECT u.idusuario,
							u.dpi,
							u.nombre,
							u.telefono,
							u.correo,
						...
						( u.idusuario LIKE '%$busqueda%' OR
							...
							r.rol    LIKE  '%$busqueda%' )
						AND estatus != 10
						ORDER BY u.idusuario {$whereExport} DESC ";

	$queryFiltro = "SELECT u.idusuario,
							u.dpi,
							u.nombre,
							u.telefono,
							u.correo,
						...
						( u.idusuario LIKE '%$busqueda%' OR
							...
							u.usuario LIKE '%$busqueda%' OR
							r.rol    LIKE  '%$busqueda%' )
						AND estatus != 10 {$whereExport}
						ORDER BY u.idusuario DESC LIMIT $desde,$por_pagina";

	$query_user = mysqli_query($conection,$queryFiltro);
...
<body>
	...
	<section id="container">
		<h1><i class="fas fa-users"></i> Buscar de usuarios</h1>
