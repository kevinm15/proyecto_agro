<?php
	...
	//Paginador
	$sql_registe = mysqli_query($conection,"SELECT COUNT(*) as total_registro FROM presentacion_producto
															WHERE ( id_presentacion LIKE '%$busqueda%' OR
																presentacion LIKE '%$busqueda%'
														   	) AND estatus != 10 ORDER BY presentacion ASC ");
	...
	$query = mysqli_query($conection,"SELECT * FROM presentacion_producto
												WHERE
													( id_presentacion LIKE '%$busqueda%' OR
													  presentacion LIKE '%$busqueda%' )
													AND
													estatus != 10 ORDER BY presentacion ASC LIMIT $desde,$por_pagina
									");
...
<head>
	...
	<title>Buscar presentación</title>
</head>
<body>
